  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ['#C9A227', '#E5C358', '#081B33', '#FFFFFF']
      });
    } catch {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[#081B33] border border-[#C9A227]/40 rounded-2xl p-6 sm:p-8 shadow-[0_0_50px_rgba(201,162,39,0.2)] text-white z-10 my-8"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            {!isSubmitted ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#C9A227] uppercase tracking-wider mb-1">
                      ...
                      <input
                        ...
                        className="w-full bg-[#0D2647] border border-[#C9A227]/30 rounded-lg px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#C9A227]"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-[#C9A227] uppercase tracking-wider mb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#0D2647] border border-[#C9A227]/30 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C9A227]"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#C9A227] uppercase tracking-wider mb-1 flex items-center gap-1">
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-[#C9A227] to-[#E5C358] hover:from-[#E5C358] hover:to-[#C9A227] text-[#081B33] font-bold py-3.5 px-6 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(201,162,39,0.3)] hover:shadow-[0_0_30px_rgba(201,162,39,0.5)] flex items-center justify-center gap-2 uppercase tracking-wider text-sm"
                    >
              ...
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-[#C9A227]/20 border border-[#C9A227] rounded-full flex items-center justify-center mx-auto mb-4 text-[#C9A227]">
                ...
                <div className="p-4 rounded-xl bg-[#0D2647] border border-[#C9A227]/20 max-w-sm mx-auto mb-6 text-left text-xs space-y-1.5 text-gray-300">
                  ...
                  <div><strong className="text-white">Status:</strong> <span className="text-[#C9A227] font-semibold">Priority VIP Processing</span></div>
                </div>
                <button
                  onClick={handleReset}
                  className="bg-[#C9A227] hover:bg-[#E5C358] text-[#081B33] font-bold px-6 py-2.5 rounded-lg text-sm transition-colors uppercase tracking-wider"
                >
