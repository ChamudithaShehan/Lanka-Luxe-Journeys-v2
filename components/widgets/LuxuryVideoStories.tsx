            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-14 h-14 rounded-full bg-[#C9A227]/90 text-[#081B33] flex items-center justify-center shadow-[0_0_25px_#C9A227] group-hover:scale-125 transition-transform duration-300">
                    <Play className="w-6 h-6 fill-current ml-1" />
                  </div>
                </div>

                <div className="absolute top-4 left-4 bg-[#081B33]/90 text-[#C9A227] border border-[#C9A227]/40 text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">
                  {language === 'kr' ? story.categoryKr : story.categoryEn}
                </div>

                <div className="absolute bottom-4 right-4 bg-[#081B33]/90 text-gray-200 text-[10px] font-mono px-2.5 py-0.5 rounded border border-white/10 flex items-center gap-1">
